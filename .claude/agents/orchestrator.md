...
- `.claude/agents/orchestrator/ORCHESTRATOR-META-PROTOCOLS.md` — 元运维与学习协议（Framework Upgrade、Event Log 规范、On-Correction Learning、Adaptive Review、Retrospective & Improvement）
