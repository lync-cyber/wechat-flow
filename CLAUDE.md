...
- 当前Sprint: Sprint 4 进行中（收尾）— 已合 main：输出能力 T-030/031(PR #8)、L3 cascade T-120/121(PR #6)、MCP server T-036/037/038/118/119/122(PR #10)、relay-backend T-032/091/033+6 图床(PR #12)、framework 0.14.0(PR #14)、relay-jobs T-034/035+composition(PR #15)。**T-039 MCP 异步导出 Tool done（feature/mcp-export-tools 待 PR）**。余 T-092（实现就绪）+ T-040/041/042/093（DESIGN 门禁）+ T-102/105/106（[DESIGN]）+ T-111（[VALIDATION]）。Sprint 0-3(PR #1/#2/#6/#7)。
