...
- 当前Sprint: Sprint 4 进行中 — **relay-jobs 切片**(feature/relay-jobs)：**T-034/T-035 done**（949 tests green，真实 Redis+chromium 本地验证），待 PR。前序 relay 切片 **PR #12 已合 main**（T-032/091/033 + 6 图床）。前序均合 main：MCP server(PR #10)、framework 0.13.1/0.14.0(PR #11/#14)、输出能力(PR #8)、L3 cascade(PR #6)；Sprint 0-3(PR #1/#2/#6/#7)。
