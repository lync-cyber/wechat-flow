...
- 当前Sprint: **Sprint 4 进行中** — 切片=L3 cascade 核心链(T-118→T-121) **✓全部 done, 收口开 PR 合 main**(T-122 defer 待 T-036), 分支 `feature/sprint-4-l3-cascade`(从 main 切出). (Sprint 1/2/3 已关闭已合 main; PR #1 framework 0.11.0→0.11.1+C-→UC- 迁移、PR #2 0.11.2 同步均已合)
